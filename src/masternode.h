...
#define TIERED_MASTERNODES_START_BLOCK         100
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 MC, signature to prove
