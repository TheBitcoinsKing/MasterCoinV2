    ...
    filter(0)
{
	...
	ui->listTransactions->setStyleSheet("color: #000000; background-image:url(\":/images/back\"); background-repeat: no-repeat;  background-position: center; border: none; padding-top: 0px; padding-bottom: 0px;");
...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeMasterCoinAmount = BitcoinUnits::formatWithUnit(nDisplayUnit, nAnonymizeMasterCoinAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if(nMaxToAnonymize >= nAnonymizeMasterCoinAmount * COIN) {
        ...
        strAnonymizeMasterCoinAmount = strAnonymizeMasterCoinAmount.remove(strAnonymizeMasterCoinAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeMasterCoinAmount + " MC / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
        ...
        strAmountAndRounds = "<span style='color:red;'>" +
                ...
                " MC / " + tr("%n Rounds", "", nDarksendRounds) + "</span>";
    }
    ui->labelAmountRounds->setText(strAmountAndRounds);
